note:<h1>the root folder is frontend and it has a backend folder inside it.I thought that frontend is enough for this assignment but ended up</h1> using backend as well.
